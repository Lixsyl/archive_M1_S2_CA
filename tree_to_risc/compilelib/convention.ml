...
let int_alloc reg offset = oper ("sd " ^ reg ^ ", " ^ string_of_int offset ^ "(sp)")
let float_alloc reg offset = oper ("fsd " ^ reg ^ ", " ^ string_of_int offset ^ "(sp)")
let int_dealloc reg offset = oper ("ld " ^ reg ^ ", " ^ string_of_int offset ^ "(sp)")
let float_dealloc reg offset = oper ("fld " ^ reg ^ ", " ^ string_of_int offset ^ "(sp)")
