...
import antlr4.ILPMLgrammar2Listener;
import static antlr4.ILPMLgrammar2Parser.*;

public class ILPMLListener implements ILPMLgrammar2Listener {
    ...
    IASTexpression e;
    if (ctx.exprs.size() == 1) {
      e = ctx.exprs.get(0).node;
    } else {
      e = factory.newSequence(toExpressions(ctx.exprs));
    }
